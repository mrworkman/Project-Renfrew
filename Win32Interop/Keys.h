...
namespace Renfrew::Win32::Interop {
    ...
    public:
        static initonly D0Key                           ^ D0                               = gcnew D0Key                              ;
        static initonly D1Key                           ^ D1                               = gcnew D1Key                              ;
        static initonly D2Key                           ^ D2                               = gcnew D2Key                              ;
        static initonly D3Key                           ^ D3                               = gcnew D3Key                              ;
        static initonly D4Key                           ^ D4                               = gcnew D4Key                              ;
        static initonly D5Key                           ^ D5                               = gcnew D5Key                              ;
        static initonly D6Key                           ^ D6                               = gcnew D6Key                              ;
        static initonly D7Key                           ^ D7                               = gcnew D7Key                              ;
        static initonly D8Key                           ^ D8                               = gcnew D8Key                              ;
        static initonly D9Key                           ^ D9                               = gcnew D9Key                              ;
        static initonly AKey                            ^ A                                = gcnew AKey                               ;
        static initonly BKey                            ^ B                                = gcnew BKey                               ;
        static initonly CKey                            ^ C                                = gcnew CKey                               ;
        static initonly DKey                            ^ D                                = gcnew DKey                               ;
        static initonly EKey                            ^ E                                = gcnew EKey                               ;
        static initonly FKey                            ^ F                                = gcnew FKey                               ;
        static initonly GKey                            ^ G                                = gcnew GKey                               ;
        static initonly HKey                            ^ H                                = gcnew HKey                               ;
        static initonly IKey                            ^ I                                = gcnew IKey                               ;
        static initonly JKey                            ^ J                                = gcnew JKey                               ;
        static initonly KKey                            ^ K                                = gcnew KKey                               ;
        static initonly LKey                            ^ L                                = gcnew LKey                               ;
        static initonly MKey                            ^ M                                = gcnew MKey                               ;
        static initonly NKey                            ^ N                                = gcnew NKey                               ;
        static initonly OKey                            ^ O                                = gcnew OKey                               ;
        static initonly PKey                            ^ P                                = gcnew PKey                               ;
        static initonly QKey                            ^ Q                                = gcnew QKey                               ;
        static initonly RKey                            ^ R                                = gcnew RKey                               ;
        static initonly SKey                            ^ S                                = gcnew SKey                               ;
        static initonly TKey                            ^ T                                = gcnew TKey                               ;
        static initonly UKey                            ^ U                                = gcnew UKey                               ;
        static initonly VKey                            ^ V                                = gcnew VKey                               ;
        static initonly WKey                            ^ W                                = gcnew WKey                               ;
        static initonly XKey                            ^ X                                = gcnew XKey                               ;
        static initonly YKey                            ^ Y                                = gcnew YKey                               ;
        static initonly ZKey                            ^ Z                                = gcnew ZKey                               ;
        static initonly LButtonKey                      ^ LButton                          = gcnew LButtonKey                         ;
        static initonly RButtonKey                      ^ RButton                          = gcnew RButtonKey                         ;
        static initonly CancelKey                       ^ Cancel                           = gcnew CancelKey                          ;
        static initonly MbuttonKey                      ^ Mbutton                          = gcnew MbuttonKey                         ;
        static initonly Xbutton1Key                     ^ Xbutton1                         = gcnew Xbutton1Key                        ;
        static initonly Xbutton2Key                     ^ Xbutton2                         = gcnew Xbutton2Key                        ;
        static initonly BackKey                         ^ Back                             = gcnew BackKey                            ;
        static initonly TabKey                          ^ Tab                              = gcnew TabKey                             ;
        static initonly ClearKey                        ^ Clear                            = gcnew ClearKey                           ;
        static initonly ReturnKey                       ^ Return                           = gcnew ReturnKey                          ;
        static initonly ShiftKey                        ^ Shift                            = gcnew ShiftKey                           ;
        static initonly ControlKey                      ^ Control                          = gcnew ControlKey                         ;
        static initonly MenuKey                         ^ Menu                             = gcnew MenuKey                            ;
        static initonly PauseKey                        ^ Pause                            = gcnew PauseKey                           ;
        static initonly CapitalKey                      ^ Capital                          = gcnew CapitalKey                         ;
        static initonly KanaKey                         ^ Kana                             = gcnew KanaKey                            ;
        static initonly HangeulKey                      ^ Hangeul                          = gcnew HangeulKey                         ;
        static initonly HangulKey                       ^ Hangul                           = gcnew HangulKey                          ;
        static initonly ImeOnKey                        ^ ImeOn                            = gcnew ImeOnKey                           ;
        static initonly JunjaKey                        ^ Junja                            = gcnew JunjaKey                           ;
        static initonly FinalKey                        ^ Final                            = gcnew FinalKey                           ;
        static initonly HanjaKey                        ^ Hanja                            = gcnew HanjaKey                           ;
        static initonly KanjiKey                        ^ Kanji                            = gcnew KanjiKey                           ;
        static initonly ImeOffKey                       ^ ImeOff                           = gcnew ImeOffKey                          ;
        static initonly EscapeKey                       ^ Escape                           = gcnew EscapeKey                          ;
        static initonly ConvertKey                      ^ Convert                          = gcnew ConvertKey                         ;
        static initonly NonconvertKey                   ^ Nonconvert                       = gcnew NonconvertKey                      ;
        static initonly AcceptKey                       ^ Accept                           = gcnew AcceptKey                          ;
        static initonly ModechangeKey                   ^ Modechange                       = gcnew ModechangeKey                      ;
        static initonly SpaceKey                        ^ Space                            = gcnew SpaceKey                           ;
        static initonly PriorKey                        ^ Prior                            = gcnew PriorKey                           ;
        static initonly NextKey                         ^ Next                             = gcnew NextKey                            ;
        static initonly EndKey                          ^ End                              = gcnew EndKey                             ;
        static initonly HomeKey                         ^ Home                             = gcnew HomeKey                            ;
        static initonly LeftKey                         ^ Left                             = gcnew LeftKey                            ;
        static initonly UpKey                           ^ Up                               = gcnew UpKey                              ;
        static initonly RightKey                        ^ Right                            = gcnew RightKey                           ;
        static initonly DownKey                         ^ Down                             = gcnew DownKey                            ;
        static initonly SelectKey                       ^ Select                           = gcnew SelectKey                          ;
        static initonly PrintKey                        ^ Print                            = gcnew PrintKey                           ;
        static initonly ExecuteKey                      ^ Execute                          = gcnew ExecuteKey                         ;
        static initonly SnapshotKey                     ^ Snapshot                         = gcnew SnapshotKey                        ;
        static initonly InsertKey                       ^ Insert                           = gcnew InsertKey                          ;
        static initonly DeleteKey                       ^ Delete                           = gcnew DeleteKey                          ;
        static initonly HelpKey                         ^ Help                             = gcnew HelpKey                            ;
        static initonly LWinKey                         ^ LWin                             = gcnew LWinKey                            ;
        static initonly RWinKey                         ^ RWin                             = gcnew RWinKey                            ;
        static initonly AppsKey                         ^ Apps                             = gcnew AppsKey                            ;
        static initonly SleepKey                        ^ Sleep                            = gcnew SleepKey                           ;
        static initonly Numpad0Key                      ^ Numpad0                          = gcnew Numpad0Key                         ;
        static initonly Numpad1Key                      ^ Numpad1                          = gcnew Numpad1Key                         ;
        static initonly Numpad2Key                      ^ Numpad2                          = gcnew Numpad2Key                         ;
        static initonly Numpad3Key                      ^ Numpad3                          = gcnew Numpad3Key                         ;
        static initonly Numpad4Key                      ^ Numpad4                          = gcnew Numpad4Key                         ;
        static initonly Numpad5Key                      ^ Numpad5                          = gcnew Numpad5Key                         ;
        static initonly Numpad6Key                      ^ Numpad6                          = gcnew Numpad6Key                         ;
        static initonly Numpad7Key                      ^ Numpad7                          = gcnew Numpad7Key                         ;
        static initonly Numpad8Key                      ^ Numpad8                          = gcnew Numpad8Key                         ;
        static initonly Numpad9Key                      ^ Numpad9                          = gcnew Numpad9Key                         ;
        static initonly MultiplyKey                     ^ Multiply                         = gcnew MultiplyKey                        ;
        static initonly AddKey                          ^ Add                              = gcnew AddKey                             ;
        static initonly SeparatorKey                    ^ Separator                        = gcnew SeparatorKey                       ;
        static initonly SubtractKey                     ^ Subtract                         = gcnew SubtractKey                        ;
        static initonly DecimalKey                      ^ Decimal                          = gcnew DecimalKey                         ;
        static initonly DivideKey                       ^ Divide                           = gcnew DivideKey                          ;
        static initonly F1Key                           ^ F1                               = gcnew F1Key                              ;
        static initonly F2Key                           ^ F2                               = gcnew F2Key                              ;
        static initonly F3Key                           ^ F3                               = gcnew F3Key                              ;
        static initonly F4Key                           ^ F4                               = gcnew F4Key                              ;
        static initonly F5Key                           ^ F5                               = gcnew F5Key                              ;
        static initonly F6Key                           ^ F6                               = gcnew F6Key                              ;
        static initonly F7Key                           ^ F7                               = gcnew F7Key                              ;
        static initonly F8Key                           ^ F8                               = gcnew F8Key                              ;
        static initonly F9Key                           ^ F9                               = gcnew F9Key                              ;
        static initonly F10Key                          ^ F10                              = gcnew F10Key                             ;
        static initonly F11Key                          ^ F11                              = gcnew F11Key                             ;
        static initonly F12Key                          ^ F12                              = gcnew F12Key                             ;
        static initonly F13Key                          ^ F13                              = gcnew F13Key                             ;
        static initonly F14Key                          ^ F14                              = gcnew F14Key                             ;
        static initonly F15Key                          ^ F15                              = gcnew F15Key                             ;
        static initonly F16Key                          ^ F16                              = gcnew F16Key                             ;
        static initonly F17Key                          ^ F17                              = gcnew F17Key                             ;
        static initonly F18Key                          ^ F18                              = gcnew F18Key                             ;
        static initonly F19Key                          ^ F19                              = gcnew F19Key                             ;
        static initonly F20Key                          ^ F20                              = gcnew F20Key                             ;
        static initonly F21Key                          ^ F21                              = gcnew F21Key                             ;
        static initonly F22Key                          ^ F22                              = gcnew F22Key                             ;
        static initonly F23Key                          ^ F23                              = gcnew F23Key                             ;
        static initonly F24Key                          ^ F24                              = gcnew F24Key                             ;
        static initonly NavigationViewKey               ^ NavigationView                   = gcnew NavigationViewKey                  ;
        static initonly NavigationMenuKey               ^ NavigationMenu                   = gcnew NavigationMenuKey                  ;
        static initonly NavigationUpKey                 ^ NavigationUp                     = gcnew NavigationUpKey                    ;
        static initonly NavigationDownKey               ^ NavigationDown                   = gcnew NavigationDownKey                  ;
        static initonly NavigationLeftKey               ^ NavigationLeft                   = gcnew NavigationLeftKey                  ;
        static initonly NavigationRightKey              ^ NavigationRight                  = gcnew NavigationRightKey                 ;
        static initonly NavigationAcceptKey             ^ NavigationAccept                 = gcnew NavigationAcceptKey                ;
        static initonly NavigationCancelKey             ^ NavigationCancel                 = gcnew NavigationCancelKey                ;
        static initonly NumlockKey                      ^ Numlock                          = gcnew NumlockKey                         ;
        static initonly ScrollKey                       ^ Scroll                           = gcnew ScrollKey                          ;
        static initonly OemNecEqualKey                  ^ OemNecEqual                      = gcnew OemNecEqualKey                     ;
        static initonly OemFjJishoKey                   ^ OemFjJisho                       = gcnew OemFjJishoKey                      ;
        static initonly OemFjMasshouKey                 ^ OemFjMasshou                     = gcnew OemFjMasshouKey                    ;
        static initonly OemFjTourokuKey                 ^ OemFjTouroku                     = gcnew OemFjTourokuKey                    ;
        static initonly OemFjLoyaKey                    ^ OemFjLoya                        = gcnew OemFjLoyaKey                       ;
        static initonly OemFjRoyaKey                    ^ OemFjRoya                        = gcnew OemFjRoyaKey                       ;
        static initonly BrowserBackKey                  ^ BrowserBack                      = gcnew BrowserBackKey                     ;
        static initonly BrowserForwardKey               ^ BrowserForward                   = gcnew BrowserForwardKey                  ;
        static initonly BrowserRefreshKey               ^ BrowserRefresh                   = gcnew BrowserRefreshKey                  ;
        static initonly BrowserStopKey                  ^ BrowserStop                      = gcnew BrowserStopKey                     ;
        static initonly BrowserSearchKey                ^ BrowserSearch                    = gcnew BrowserSearchKey                   ;
        static initonly BrowserFavoritesKey             ^ BrowserFavorites                 = gcnew BrowserFavoritesKey                ;
        static initonly BrowserHomeKey                  ^ BrowserHome                      = gcnew BrowserHomeKey                     ;
        static initonly VolumeMuteKey                   ^ VolumeMute                       = gcnew VolumeMuteKey                      ;
        static initonly VolumeDownKey                   ^ VolumeDown                       = gcnew VolumeDownKey                      ;
        static initonly VolumeUpKey                     ^ VolumeUp                         = gcnew VolumeUpKey                        ;
        static initonly MediaNextTrackKey               ^ MediaNextTrack                   = gcnew MediaNextTrackKey                  ;
        static initonly MediaPrevTrackKey               ^ MediaPrevTrack                   = gcnew MediaPrevTrackKey                  ;
        static initonly MediaStopKey                    ^ MediaStop                        = gcnew MediaStopKey                       ;
        static initonly MediaPlayPauseKey               ^ MediaPlayPause                   = gcnew MediaPlayPauseKey                  ;
        static initonly LaunchMailKey                   ^ LaunchMail                       = gcnew LaunchMailKey                      ;
        static initonly LaunchMediaSelectKey            ^ LaunchMediaSelect                = gcnew LaunchMediaSelectKey               ;
        static initonly LaunchApp1Key                   ^ LaunchApp1                       = gcnew LaunchApp1Key                      ;
        static initonly LaunchApp2Key                   ^ LaunchApp2                       = gcnew LaunchApp2Key                      ;
        static initonly Oem1Key                         ^ Oem1                             = gcnew Oem1Key                            ;
        static initonly OemPlusKey                      ^ OemPlus                          = gcnew OemPlusKey                         ;
        static initonly OemCommaKey                     ^ OemComma                         = gcnew OemCommaKey                        ;
        static initonly OemMinusKey                     ^ OemMinus                         = gcnew OemMinusKey                        ;
        static initonly OemPeriodKey                    ^ OemPeriod                        = gcnew OemPeriodKey                       ;
        static initonly Oem2Key                         ^ Oem2                             = gcnew Oem2Key                            ;
        static initonly Oem3Key                         ^ Oem3                             = gcnew Oem3Key                            ;
        static initonly GamepadAKey                     ^ GamepadA                         = gcnew GamepadAKey                        ;
        static initonly GamepadBKey                     ^ GamepadB                         = gcnew GamepadBKey                        ;
        static initonly GamepadXKey                     ^ GamepadX                         = gcnew GamepadXKey                        ;
        static initonly GamepadYKey                     ^ GamepadY                         = gcnew GamepadYKey                        ;
        static initonly GamepadRightShoulderKey         ^ GamepadRightShoulder             = gcnew GamepadRightShoulderKey            ;
        static initonly GamepadLeftShoulderKey          ^ GamepadLeftShoulder              = gcnew GamepadLeftShoulderKey             ;
        static initonly GamepadLeftTriggerKey           ^ GamepadLeftTrigger               = gcnew GamepadLeftTriggerKey              ;
        static initonly GamepadRightTriggerKey          ^ GamepadRightTrigger              = gcnew GamepadRightTriggerKey             ;
        static initonly GamepadDpadUpKey                ^ GamepadDpadUp                    = gcnew GamepadDpadUpKey                   ;
        static initonly GamepadDpadDownKey              ^ GamepadDpadDown                  = gcnew GamepadDpadDownKey                 ;
        static initonly GamepadDpadLeftKey              ^ GamepadDpadLeft                  = gcnew GamepadDpadLeftKey                 ;
        static initonly GamepadDpadRightKey             ^ GamepadDpadRight                 = gcnew GamepadDpadRightKey                ;
        static initonly GamepadMenuKey                  ^ GamepadMenu                      = gcnew GamepadMenuKey                     ;
        static initonly GamepadViewKey                  ^ GamepadView                      = gcnew GamepadViewKey                     ;
        static initonly GamepadLeftThumbstickButtonKey  ^ GamepadLeftThumbstickButton      = gcnew GamepadLeftThumbstickButtonKey     ;
        static initonly GamepadRightThumbstickButtonKey ^ GamepadRightThumbstickButton     = gcnew GamepadRightThumbstickButtonKey    ;
        static initonly GamepadLeftThumbstickUpKey      ^ GamepadLeftThumbstickUp          = gcnew GamepadLeftThumbstickUpKey         ;
        static initonly GamepadLeftThumbstickDownKey    ^ GamepadLeftThumbstickDown        = gcnew GamepadLeftThumbstickDownKey       ;
        static initonly GamepadLeftThumbstickRightKey   ^ GamepadLeftThumbstickRight       = gcnew GamepadLeftThumbstickRightKey      ;
        static initonly GamepadLeftThumbstickLeftKey    ^ GamepadLeftThumbstickLeft        = gcnew GamepadLeftThumbstickLeftKey       ;
        static initonly GamepadRightThumbstickUpKey     ^ GamepadRightThumbstickUp         = gcnew GamepadRightThumbstickUpKey        ;
        static initonly GamepadRightThumbstickDownKey   ^ GamepadRightThumbstickDown       = gcnew GamepadRightThumbstickDownKey      ;
        static initonly GamepadRightThumbstickRightKey  ^ GamepadRightThumbstickRight      = gcnew GamepadRightThumbstickRightKey     ;
        static initonly GamepadRightThumbstickLeftKey   ^ GamepadRightThumbstickLeft       = gcnew GamepadRightThumbstickLeftKey      ;
        static initonly Oem4Key                         ^ Oem4                             = gcnew Oem4Key                            ;
        static initonly Oem5Key                         ^ Oem5                             = gcnew Oem5Key                            ;
        static initonly Oem6Key                         ^ Oem6                             = gcnew Oem6Key                            ;
        static initonly Oem7Key                         ^ Oem7                             = gcnew Oem7Key                            ;
        static initonly Oem8Key                         ^ Oem8                             = gcnew Oem8Key                            ;
        static initonly OemAxKey                        ^ OemAx                            = gcnew OemAxKey                           ;
        static initonly Oem102Key                       ^ Oem102                           = gcnew Oem102Key                          ;
        static initonly IcoHelpKey                      ^ IcoHelp                          = gcnew IcoHelpKey                         ;
        static initonly Ico00Key                        ^ Ico00                            = gcnew Ico00Key                           ;
        static initonly ProcesskeyKey                   ^ Processkey                       = gcnew ProcesskeyKey                      ;
        static initonly IcoClearKey                     ^ IcoClear                         = gcnew IcoClearKey                        ;
        static initonly PacketKey                       ^ Packet                           = gcnew PacketKey                          ;
        static initonly OemResetKey                     ^ OemReset                         = gcnew OemResetKey                        ;
        static initonly OemJumpKey                      ^ OemJump                          = gcnew OemJumpKey                         ;
        static initonly OemPa1Key                       ^ OemPa1                           = gcnew OemPa1Key                          ;
        static initonly OemPa2Key                       ^ OemPa2                           = gcnew OemPa2Key                          ;
        static initonly OemPa3Key                       ^ OemPa3                           = gcnew OemPa3Key                          ;
        static initonly OemWsctrlKey                    ^ OemWsctrl                        = gcnew OemWsctrlKey                       ;
        static initonly OemCuselKey                     ^ OemCusel                         = gcnew OemCuselKey                        ;
        static initonly OemAttnKey                      ^ OemAttn                          = gcnew OemAttnKey                         ;
        static initonly OemFinishKey                    ^ OemFinish                        = gcnew OemFinishKey                       ;
        static initonly OemCopyKey                      ^ OemCopy                          = gcnew OemCopyKey                         ;
        static initonly OemAutoKey                      ^ OemAuto                          = gcnew OemAutoKey                         ;
        static initonly OemEnlwKey                      ^ OemEnlw                          = gcnew OemEnlwKey                         ;
        static initonly OemBacktabKey                   ^ OemBacktab                       = gcnew OemBacktabKey                      ;
        static initonly AttnKey                         ^ Attn                             = gcnew AttnKey                            ;
        static initonly CrselKey                        ^ Crsel                            = gcnew CrselKey                           ;
        static initonly ExselKey                        ^ Exsel                            = gcnew ExselKey                           ;
        static initonly EreofKey                        ^ Ereof                            = gcnew EreofKey                           ;
        static initonly PlayKey                         ^ Play                             = gcnew PlayKey                            ;
        static initonly ZoomKey                         ^ Zoom                             = gcnew ZoomKey                            ;
        static initonly NonameKey                       ^ Noname                           = gcnew NonameKey                          ;
        static initonly Pa1Key                          ^ Pa1                              = gcnew Pa1Key                             ;
        static initonly OemClearKey                     ^ OemClear                         = gcnew OemClearKey                        ;
    };
}
