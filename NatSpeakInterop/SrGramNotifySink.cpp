...
SrGramNotifySink::SrGramNotifySink(
    Action<UInt32, Object^, ISrResBasic^>^ phraseFinishCallback,
...
void SrGramNotifySink::PhraseFinish(
    DWORD flags,
    QWORD,
    QWORD,
    ...
    auto isrResBasic = (ISrResBasic^) Marshal::GetObjectForIUnknown(
        IntPtr(pIUnknown)
    );
...
void SrGramNotifySink::PhraseHypothesis(
    DWORD,
    QWORD,
    QWORD,
    PSRPHRASEW,
